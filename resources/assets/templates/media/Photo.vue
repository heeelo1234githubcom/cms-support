				...
				<div class="col-md-3">
					...
					<div class="col-md-12" style="margin-top: 10px;">
							...
							<form class="panel-body" ref="formMedia"  @submit.prevent="onSaveMedia" :action="saveMediaUrl" method="post" autocomplete="off">
								...
								<fieldset class="form-group">
									<label class="custom-file">{{ file }}
										<input accept="image/*" name="file" type="file" class="custom-file-input">
						...
						<div class="text-right" style="margin-top: 15px;">
							<button v-if="formData.media_id" v-on:click="makeAddForm" class="btn btn-danger btn-small"><i class="fa fa-plus"></i> Thêm ảnh mới</button>
							&nbsp;&nbsp;&nbsp;
...
<script>
    ...
    export default {
		...
		data () {
            let $data = Application.languages['mediaPhoto'];
                ...
                this.$http.post($requestUrl).then(
                    function ($response) {
                        if (typeof $response.body.data !== 'undefined') {
                            ...
                            self.$data['formHeader'] = 'Cập nhật ảnh:';
