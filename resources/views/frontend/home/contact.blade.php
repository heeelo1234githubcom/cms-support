    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <form class="ajax-form-submit" action="{{ route('contact_submit') }}" method="post">
                    {{ csrf_field() }}
                    <div class="row">
...
@section('page-script')
    ...
    <script>
        function initMap() {
            ...
            var contentString = '<div class="map-info-content"><strong>Nha Khoa Giá Tốt</strong>{!! get_contact_info() !!}</div>';
